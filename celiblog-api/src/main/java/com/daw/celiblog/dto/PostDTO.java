...
public class PostDTO {
    ...
    public PostDTO(Long idPost, Date fechaPublicacion, String contenido, UsuarioDTO usuarioDTO, String urlPost, EstadoValidacion estado, Date fechaValidacion, int valoracion) {
        this.idPost = idPost;
